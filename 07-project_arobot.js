...
function compareRobots(robot1, memory1, robot2, memory2) {
    ...
    for(let i = 0; i < 100; i++){
        ...
        total1 = total1 + countSteps(state, robot1, memory1);
        total2 = total2 + countSteps(state, robot2, memory2);
    }
...
Like Group, it has add, delete, and has methods.Its add method, however, should return a new PGroup instance with 
the given member added and leave the old one unchanged. Similarly, delete creates a new instance without a given member.
